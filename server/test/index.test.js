  ...
  describe("GET /rickandmorty/character/:id", () => {
    ...
    describe("GET /rickandmorty/login", () => {
      it("Valida acceso fallido con información de login incorrecta", async () => {
        const response = await agent.get(
          "/rickandmorty/login?email=incorrect@gmail.com&password=incorrect123"
        );
    ...
    describe("DELETE /rickandmorty/fav/:id", () => {
      ...
      it("Debe eliminar correctamente al personaje cuando se envía un ID válido", async () => {
        ...
        // Utilizar comillas invertidas para construir correctamente la cadena de solicitud DELETE
